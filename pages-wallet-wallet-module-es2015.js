...
/* harmony import */ var _wallet__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./wallet */ "./src/app/pages/wallet/wallet.ts");
...
/* harmony import */ var _wallet__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./wallet */ "./src/app/pages/wallet/wallet.ts");
...
/* harmony import */ var _wallet_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./wallet-routing.module */ "./src/app/pages/wallet/wallet-routing.module.ts");
...
WalletPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _wallet_routing_module__WEBPACK_IMPORTED_MODULE_7__["WalletPageRoutingModule"]
        ],
        declarations: [
            _wallet__WEBPACK_IMPORTED_MODULE_5__["WalletPage"],
        ],
...
let WalletPage = class WalletPage {
    constructor(_ProductService, _Router, clipboard, toastController, _UserData, platform, socialSharing) {
    ...
    getCashBackList(event = this.refershDefault) {
        let shopId = localStorage.getItem('shopID');
        this._ProductService.getWallet(localStorage.getItem('userId')).subscribe((data) => {
            console.log(data, "cashback list");
            this.cashbackList = data;
            this.cashbackList.forEach((list) => {
                this.total = this.total + parseInt(list.amount);
            });
            if (this.cashbackList.length !== 0) {
                console.log(this.cashbackList, "cashbackList");
    ...
    share() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.socialSharing
                .share("Use my Refer code : " + this.userData.referCode)
                .then(() => { })
                .catch((err) => {
                console.log(err);
            });
...
WalletPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./wallet.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/wallet/wallet.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./wallet.scss */ "./src/app/pages/wallet/wallet.scss")).default]
    }),
