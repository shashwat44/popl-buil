...
/* harmony import */ var _wishList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./wishList */ "./src/app/pages/wishList/wishList.ts");
...
/* harmony import */ var _wishList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./wishList */ "./src/app/pages/wishList/wishList.ts");
...
/* harmony import */ var _wishList_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./wishList-routing.module */ "./src/app/pages/wishList/wishList-routing.module.ts");
...
WishListModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _wishList_routing_module__WEBPACK_IMPORTED_MODULE_7__["WishListPageRoutingModule"],
...
let WishListPage = class WishListPage {
    constructor(_ProductService, toastController, imageLoader, imageLoaderConfig) {
    ...
    getwishList(event = this.refershDefault) {
        // this.imageLoader.clearCache();
        let shopId = localStorage.getItem('shopID');
        this._ProductService.getAllWishList(localStorage.getItem('userId'), shopId).subscribe((data) => {
            console.log(data, "data");
            this.isDataLoaded = true;
            if (data.length !== 0) {
                // setTimeout(()=>{
                this.wishList = data[0].productDetails;
                // this.wishList.forEach((cart) => {
                //   cart.price =
    ...
    removeToWishList(productData) {
        ...
        console.log(payload);
        this._ProductService.AddToWishCart('remove', payload).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (data) {
                console.log(data, "data");
                this.getwishList();
            }
...
WishListPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./wishList.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/wishList/wishList.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./wishList.scss */ "./src/app/pages/wishList/wishList.scss")).default]
    }),
