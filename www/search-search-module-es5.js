...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["search-search-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesSearchSearchHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesSearchSearchModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _search__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./search */
    "./src/app/pages/search/search.ts");
    /* harmony import */
    ...
    SearchPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _search_routing_module__WEBPACK_IMPORTED_MODULE_7__["SearchPageRoutingModule"], ionic_image_loader__WEBPACK_IMPORTED_MODULE_6__["IonicImageLoader"]],
      declarations: [_search__WEBPACK_IMPORTED_MODULE_5__["SearchPage"]],
      entryComponents: []
    })], SearchPageModule);
    /***/
  },
  ...
  /***/
  function srcAppPagesSearchSearchScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesSearchSearchTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SearchPage = /*#__PURE__*/function () {
      function SearchPage(_ProductService, _Router, imageLoader) {
      ...
      _createClass(SearchPage, [{
        ...
        value: function ngAfterViewInit() {
          ...
          setTimeout(function () {
            return _this.searchbar.setFocus();
          }, 500);
        }
      }, {
        key: "getProductList",
        value: function getProductList() {
          ...
          this._ProductService.getProductList(localStorage.getItem("shopID")).subscribe(function (data) {
            ...
            _this2.productList = _this2.productList.map(function (obj) {
              return Object.assign({}, obj, {
                QTY: 0
              });
            });

            _this2.productList.forEach(function (product) {
              product.price = _this2.convertIntoLakh(product.price);
            });
        ...
        value: function search(query) {
          ...
          if (query.target.value.length >= 1) {
            ...
            this._ProductService.search({
              ...
              data.productList = data.productList.map(function (obj) {
                return Object.assign({}, obj, {
                  QTY: 0,
                  rating: 0
                });
              });
              _this3.productList = data.productList;

              _this3.productList.forEach(function (product) {
                product.price = _this3.convertIntoLakh(product.price);
              });
            });
          } else {
            this.clear();
    ...
    SearchPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! raw-loader!./search.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/search/search.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./search.scss */
      "./src/app/pages/search/search.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_product_services__WEBPACK_IMPORTED_MODULE_2__["ProductService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], ionic_image_loader__WEBPACK_IMPORTED_MODULE_5__["ImageLoaderService"]])], SearchPage);
    /***/
  }
}]);
