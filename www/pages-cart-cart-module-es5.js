...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-cart-cart-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesCartCartHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesCartCartRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _cart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./cart */
  ...
  function srcAppPagesCartCartModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    CartPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _cart_routing_module__WEBPACK_IMPORTED_MODULE_6__["CartPageRoutingModule"]],
      declarations: [_cart__WEBPACK_IMPORTED_MODULE_5__["CartPage"]],
      entryComponents: []
    })], CartPageModule);
    /***/
  },
  ...
  /***/
  function srcAppPagesCartCartScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesCartCartTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CartPage = /*#__PURE__*/function () {
      function CartPage(toastController, _ProductService, Router) {
      ...
      _createClass(CartPage, [{
        ...
        value: function ngOnInit() {
          this.refreshList();
          this.getProductList();
          this.getAddress(); // this.getCartListHome();
        ...
        value: function getCartList() {
          ...
          this._ProductService.cartList(localStorage.getItem("userId"), shopId).subscribe(function (data) {
            ...
            if (data.length !== 0) {
              _this.cartList = data[0].productDetails;
              _this.cartId = data[0]._id;
              var total = 0;
              _this.cartList = data[0]["productDetails"].filter(function (productData) {
              ...
              data[0]["productDetails"].forEach(function (val) {
                if (val.productId) {
                  ...
                  val["discountedPrice"] = (price - discountedPrice).toFixed(2); // val['discountedPrice'] = parseFloat(val['discountedPrice'])
                }
              });
              console.log(_this.cartList, " this.cartList");
              console.log(total);
              _this.orderTotal = total.toFixed(2);
            } else {
        ...
        value: function getWishList() {
          ...
          this._ProductService.getAllWishList(localStorage.getItem("userId"), shopId).subscribe(function (data) {
            ...
            if (data.length !== 0) {
              _this2.wishList = data[0].productDetails; // this.cartId = data[0]._id
            } else {// this.enableBtn = true
              }
        ...
        value: function getProductList() {
          ...
          this._ProductService.getProductList(shopId).subscribe(function (data) {
            _this3.fetchReviewList();

            _this3.productList = data;
            _this3.productList = _this3.productList.map(function (obj) {
        ...
        value: function fetchReviewList() {
          ...
          this._ProductService.getAllReviewList(localStorage.getItem("userId")).subscribe(function (response) {
            resp = response;
            _this4.reviewList = resp;
            console.log(_this4.reviewList, "reviewList");
          });
        }
      }, {
        key: "addTocart",
        value: function addTocart(cart) {
          var _this5 = this;
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      if (data) {
                        ...
                        this.syncBoughtTogether(); // const toast = await this.toastController.create({
        ...
        key: "saveForLater",
        value: function saveForLater(flag, action, cart) {
          var _this6 = this;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 6:
                      ...
                      if (action == "add") {
                        msg = "Saved For Later"; // this.isProductAddedToWishList = true
                      } else {
                        msg = "Removed From Saced For Later Products"; // this.isProductAddedToWishList = false
        ...
        value: function refreshList() {
          ...
          this.getCartList();
          this.getWishList(); // this.syncBoughtTogether();
        ...
        key: "syncBoughtTogether",
        value: function syncBoughtTogether() {
          var _this8 = this;
          ...
          this._ProductService.cartList(localStorage.getItem("userId"), shopId).subscribe(function (data) {
            ...
            if (data.length !== 0) {
              var addedProductList = data[0].productDetails;
              addedProductList = data[0]["productDetails"].filter(function (productData) {
                return productData.productId !== null;
              });

              if (addedProductList.length == 0) {
                _this8.addedToCartProductIds = [];
                return;
              }

              addedProductList.forEach(function (productData) {
                _this8.productList.forEach(function (obj) {
                  if (obj._id == productData.productId._id) {
                    ...
                    if (productData.productCount > 0) {
                      _this8.addedToCartProductIds.push(obj._id);
                    } else {
                      var index = _this8.addedToCartProductIds.indexOf(obj._id);

                      if (index > -1) {
                        _this8.addedToCartProductIds.splice(index, 1);
                      }
                    }
                  }
                });

                _this8.cartList = data[0].productDetails;
                _this8.cartList = data[0]["productDetails"].filter(function (productData) {
                  return productData.productId !== null;
                });
                _this8.cartId = data[0]._id;
                var total = 0;
                data[0]["productDetails"].forEach(function (val) {
                  if (val.productId) {
                    var discount = val.productId.discount;
                    ...
                    _this8.productList.forEach(function (product, index) {
                      if (product._id == val.productId._id) {
                        _this8.productList.splice(index, 1);
                      }
                    });
                  }
                });
                console.log(total);
                _this8.orderTotal = total.toFixed(2); // this.getWishList();
              });
            } else {
              _this8.enableBtn = true;
            }
          });
        }
      }, {
        ...
        value: function getAddress() {
          ...
          this._ProductService.getAddress(localStorage.getItem("userId")).subscribe(function (data) {
            ...
            _this9.addressData = data;
            console.log(addressList);
          });
        }
      }, {
        key: "removeToWishList",
        value: function removeToWishList(x) {}
      }, {
        key: "search",
        value: function search(query) {
          ...
          if (query.target.value.length >= 2) {
            ...
            this._ProductService.search({
              ...
              filter: "Product"
            }, shopId).subscribe(function (data) {
              console.log(data, "data");
              _this10.searchproductList = data.productList;
            });
          }
        ...
        key: "addTocartHome",
        value: function addTocartHome(productData) {
          var _this11 = this;
          ...
          this._ProductService.addToCart("add", payload).subscribe(function (data) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this11, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      this.getCartList();
                      this.syncBoughtTogether(); // if (data) {
                      //   this.saveForLater("N", "remove", cart);
                      //   const toast = await this.toastController.create({
                      //     message: "Moved To Cart",
                      //      duration: 3000,
        ...
        key: "cartActionHome",
        value: function cartActionHome(action, productData) {
          var _this12 = this;
        ...
        key: "getCartListHome",
        value: function getCartListHome() {
          var _this13 = this;
          ...
          this._ProductService.cartList(localStorage.getItem("userId"), shopId).subscribe(function (data) {
            ...
            if (data.length !== 0) {
              data[0].productDetails.forEach(function (products) {
                arr.push(products.productId._id);

                _this13.productList.forEach(function (obj) {
            ...
            _this13.addedToCartProductIds = _this13.addedToCartProductIds.concat(arr);
            console.log(_this13.addedToCartProductIds, "list - cart sync");
          });
        }
      }]);
    ...
    CartPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! raw-loader!./cart.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/cart/cart.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./cart.scss */
      "./src/app/pages/cart/cart.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"], _providers_product_services__WEBPACK_IMPORTED_MODULE_3__["ProductService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])], CartPage);
    /***/
  }
}]);
