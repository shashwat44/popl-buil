...
/* harmony import */ var _orders__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./orders */ "./src/app/pages/orders/orders.ts");
...
/* harmony import */ var _orders__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./orders */ "./src/app/pages/orders/orders.ts");
...
/* harmony import */ var _orders_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./orders-routing.module */ "./src/app/pages/orders/orders-routing.module.ts");
...
OrdersPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _orders_routing_module__WEBPACK_IMPORTED_MODULE_7__["OrdersPageRoutingModule"],
            ionic_image_loader__WEBPACK_IMPORTED_MODULE_6__["IonicImageLoader"]
        ],
        declarations: [
            _orders__WEBPACK_IMPORTED_MODULE_5__["OrdersPage"],
        ],
        entryComponents: []
    })
], OrdersPageModule);
...
let OrdersPage = class OrdersPage {
    ...
    getorderList(event = this.refershDefault) {
        this._ProductService
            .getOrderList(this.page, localStorage.getItem("userId"))
            .subscribe((response) => {
    ...
    loadOrderData(event) {
        ...
        this._ProductService.getOrderList(this.page, localStorage.getItem("userId")).subscribe((response) => {
            console.log(this.orderList, "orderList");
            setTimeout(() => {
                console.log('Done');
                event.target.complete();
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("autofocus", { static: false }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonSearchbar"])
], OrdersPage.prototype, "searchbar", void 0);
OrdersPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "page-orders",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./orders.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/orders/orders.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./orders.scss */ "./src/app/pages/orders/orders.scss")).default]
    }),
