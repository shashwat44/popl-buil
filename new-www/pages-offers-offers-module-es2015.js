...
/* harmony import */ var _offers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./offers */ "./src/app/pages/offers/offers.ts");
...
/* harmony import */ var _offers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./offers */ "./src/app/pages/offers/offers.ts");
...
/* harmony import */ var _offers_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./offers-routing.module */ "./src/app/pages/offers/offers-routing.module.ts");
...
let OffersPage = class OffersPage {
    constructor(_ProductService, clipboard, toastController, _Router) {
    ...
    ngOnInit() {
        this.filter = (this._Router.snapshot.params.filter == 'all') ? '' : this._Router.snapshot.params.filter;
        // if(filter){
        // }
    ...
    fetchOffers() {
        this.getCartCount();
        this._ProductService.listOffer(this.filter).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(res);
            if (res) {
...
OffersPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./offers.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/offers/offers.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./offers.scss */ "./src/app/pages/offers/offers.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_product_services__WEBPACK_IMPORTED_MODULE_3__["ProductService"], _ionic_native_clipboard_ngx__WEBPACK_IMPORTED_MODULE_4__["Clipboard"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ToastController"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
], OffersPage);
