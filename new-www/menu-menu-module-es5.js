  ...
  function node_modulesAngularMaterialEsm2015SelectJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatSelect = /*#__PURE__*/function (_MatSelectMixinBase2) {
      ...
      function MatSelect(_viewportRuler, _changeDetectorRef, _ngZone, _defaultErrorStateMatcher, elementRef, _dir, _parentForm, _parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer) {
        ...
        _this5 = _super2.call(this, elementRef, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl);
      ...
      _createClass(AdvanceSearchModelPage, [{
        ...
        value: function getSubCategoryList() {
          ...
          this._ProductService.listSubCategory().subscribe(function (data) {
            _this16.SubCategoryList = data.SubCategoryList;
          });
        }
      }, {
        key: "selectBrand",
      ...
      _createClass(ViewMenuPage, [{
        ...
        value: function getProductList() {
          ...
          this._ProductService.getProductList(shopId, params).subscribe(function (data) {
            console.log(_this17.productList, "this.productList");
            _this17.productList = data;
            _this17.isDataLoaded = true;
            _this17.productList = _this17.productList.map(function (obj) {
              return Object.assign({}, obj, {
                QTY: 0
              });
            });

            _this17.presentLoading();

            _this17.productList.forEach(function (product) {
              product.price = _this17.convertIntoLakh(product.price);
      ...
      _createClass(TabMenuPage, [{
        ...
        value: function makeSelectedCategoryDefault() {
          ...
          this._shopService.listSubCategory().subscribe(function (data) {
            _this18.subcategoryList = data.SubCategoryList;
            _this18.selectedSubCategory = _this18.subcategoryList[1]._id;
            console.log(data, "set default --------------------------", _this18.selectedSubCategory);

            _this18.tabAction();

            _this18.getProductList();

            _this18.getSubCategoryList();
          });
        }
      }, {
        key: "getProductList",
        value: function getProductList() {
          ...
          this._shopService.fetchProductList({
            ...
            _this19.productList = data;
            _this19.backupProductList = data;
            console.log(_this19.productList);
          });
        }
      }, {
        key: "getSubCategoryList",
        value: function getSubCategoryList() {
          ...
          this._shopService.listSubCategory().subscribe(function (data) {
            _this20._shopService.getMenuList().subscribe(function (res) {
              _this20.subcategoryList = data.SubCategoryList;
              _this20.subcategoryList.products = []; // if(this.selectedSubCategory == undefined && this.subcategoryList){
              //   this.selectedSubCategory =   this.subcategoryList[1]._id
              // }
              // console.log(data, "pp--------------------------", this.selectedSubCategory);

              _this20.menuList = res;

              _this20.mapSubCategoryList(res);
            });
          });
        }
      }, {
        ...
        value: function assignProduct() {
          ...
          this._shopService.assignProductToCategory({
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this21, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
              var toast;
