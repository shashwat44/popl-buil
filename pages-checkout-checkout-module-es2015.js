...
/* harmony import */ var _checkout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./checkout */ "./src/app/pages/checkout/checkout.ts");
...
/* harmony import */ var _checkout__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./checkout */ "./src/app/pages/checkout/checkout.ts");
/* harmony import */ var _checkout_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./checkout-routing.module */ "./src/app/pages/checkout/checkout-routing.module.ts");
/* harmony import */ var _modal_checkOutOffer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modal/checkOutOffer */ "./src/app/pages/checkout/modal/checkOutOffer.ts");
...
CheckoutPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _checkout_routing_module__WEBPACK_IMPORTED_MODULE_7__["CheckoutPageRoutingModule"],
        ],
        declarations: [
            _checkout__WEBPACK_IMPORTED_MODULE_6__["CheckoutPage"],
            _modal_checkOutOffer__WEBPACK_IMPORTED_MODULE_8__["CheckOutOfferPage"]
        ],
        entryComponents: [
            _modal_checkOutOffer__WEBPACK_IMPORTED_MODULE_8__["CheckOutOfferPage"]
        ],
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
/* harmony import */ var _modal_checkOutOffer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modal/checkOutOffer */ "./src/app/pages/checkout/modal/checkOutOffer.ts");
...
let CheckoutPage = class CheckoutPage {
    constructor(_ProductService, _Router, Router, toastController, modalController, _UserData) {
    ...
    getCartList() {
        ...
        this._ProductService
            ...
            this.cartList = data.length == 0 ? [] : data[0].productDetails;
            ...
            data[0]["productDetails"].forEach((val) => {
                if (val.productId) {
                    ...
                    // alert("price : " + price + "discount : " + discount  )
                    // alert("discounted Price : " + discountedPrice + "final : " + val["discountedPrice"]  )
                }
            });
            console.log(total);
            this.orderTotal = total.toFixed(2);
            this.itemValue = total.toFixed(2);
            this._ProductService.listOffer("").subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                console.log(res);
                if (res) {
                    this._offerList = res["data"];
                }
                this._offerList.forEach((offer) => {
                    if (offer.isRewardSetting &&
                        offer.minAmount <= parseInt(this.orderTotal)) {
                        this.aplicableofferDiscountArr.push(offer.discountedAmount);
                    }
                });
                this._offerList = this._offerList.filter((offer) => parseInt(offer.minAmount) > parseInt(this.orderTotal));
    ...
    getAddress() {
        this._ProductService
            .getAddressDetails(localStorage.getItem("userId"), this.addressId)
            .subscribe((data) => {
    ...
    getCouponsList() {
        let arr = [];
        this._ProductService.listOffer(false).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(res);
            if (res) {
    ...
    apply() {
        ...
        this._couponsList.forEach((offer) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    payment() {
        let self = this;
        // self.Router.navigateByUrl(`/orderSummary/12364`);
        this._ProductService
            .getCheckSum({
            mobile: "8920832260",
            email: "abc@gmail.com",
            ...
            let orderId = data.payload.ORDER_ID;
            // let options = {
            ...
            paytm.startPayment(options, function (success) {
                ...
                self._ProductService.orderProduct(payload).subscribe((data) => {
                    console.log(data, "orderData");
                    if (success.STATUS == "TXN_SUCCESS") {
                        let orderId = data[0].saveDataInOrderTable.orderId;
                        self.Router.navigateByUrl(`/orderSummary/${orderId}`);
                    }
                    else {
    ...
    getCustomerProfile() {
        this._UserData
            ...
            .subscribe((data) => {
            this.userData = data;
            // this.userData.walletBalance = 1000;
...
CheckoutPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./checkout.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/checkout/checkout.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./checkout.scss */ "./src/app/pages/checkout/checkout.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheckOutOfferPage", function() { return CheckOutOfferPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _providers_product_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../providers/product.services */ "./src/app/providers/product.services.ts");
...
let CheckOutOfferPage = class CheckOutOfferPage {
    constructor(_ProductService, clipboard, toastController, modalController, _Router) {
        this._ProductService = _ProductService;
    ...
    getCashbacks() {
        this._ProductService.getCashBacks(localStorage.getItem('userId')).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(res);
            if (res) {
                let list = res;
                list.forEach((val) => {
                    this.reedemCount = this.reedemCount + val.amount;
                });
            }
        }));
    }
    ...
    fetchOffers() {
        this.getCartCount();
        this._ProductService.listOffer(this.filterData).subscribe((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(res);
            if (res) {
                this._offerList = res["data"];
            }
...
CheckOutOfferPage.ctorParameters = () => [
    { type: _providers_product_services__WEBPACK_IMPORTED_MODULE_3__["ProductService"] },
...
], CheckOutOfferPage.prototype, "filterData", void 0);
CheckOutOfferPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "page-checkOutOffer",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./checkOutOffer.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/checkout/modal/checkOutOffer.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./checkOutOffer.scss */ "./src/app/pages/checkout/modal/checkOutOffer.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_product_services__WEBPACK_IMPORTED_MODULE_3__["ProductService"], _ionic_native_clipboard_ngx__WEBPACK_IMPORTED_MODULE_4__["Clipboard"],
