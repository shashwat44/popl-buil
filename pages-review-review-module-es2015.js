...
/* harmony import */ var _review__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./review */ "./src/app/pages/review/review.ts");
...
/* harmony import */ var _review__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./review */ "./src/app/pages/review/review.ts");
...
/* harmony import */ var _review_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./review-routing.module */ "./src/app/pages/review/review-routing.module.ts");
...
ReviewPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _review_routing_module__WEBPACK_IMPORTED_MODULE_7__["ReviewPageRoutingModule"],
            ionic_image_loader__WEBPACK_IMPORTED_MODULE_6__["IonicImageLoader"]
        ],
        declarations: [
            _review__WEBPACK_IMPORTED_MODULE_5__["ReviewPage"],
        ],
        entryComponents: []
    })
], ReviewPageModule);
...
let ReviewPage = class ReviewPage {
    constructor(modalController, _toast, route, alertController, _ProductService, Router) {
    ...
    rate(index, id) {
        ...
        this.productDetails.rating = index;
    ...
    SubmitReview() {
        ...
        this._ProductService
            ...
            toast.present();
            setTimeout(() => {
                this.Router.navigateByUrl("/productDetails/" + this.productDetails._id);
            }, 600);
        }));
    }
};
...
ReviewPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./review.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/review/review.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./review.scss */ "./src/app/pages/review/review.scss")).default]
    }),
